...
const MoreProducts = () => {
  return (<>
                    ...
                    <div className="h-1 ml-5 w-20 bg-black rounded"></div>

  <h2 className="font-montserrat text-sm md:text-md mt-5  md:font-bold  text-center ">Your Space, Your Style: Find Unique Home Decor Gems
</h2>
